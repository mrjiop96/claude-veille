...
- 2026-07-23 : veille auto — +1 feature (eco-economic-index-connector : connecteur MCP Anthropic Economic Index, interrogation en langage naturel des données d'adoption IA par État/métier), +4 news (Claude Code v2.1.218 : /code-review en sous-agent fond, /deep-research manuel, skills context:fork en bg par défaut, plan mode auto sans prompt lecture seule, 20+ correctifs, 22 juil. ; connecteur Anthropic Economic Index, 22 juil. ; fonds Economic Futures Research 200 M$ agenda, 22 juil. ; Anthropic +20 M$ à Public First Action → 40 M$ total, 22 juil.) → 36 features, 52 news.
- 2026-07-24 : veille auto — +1 news (suppression fast mode claude-opus-4-7 au 24 juil. : erreur sur toute requête fast mode, migration vers Opus 4.8) → 36 features, 53 news.
